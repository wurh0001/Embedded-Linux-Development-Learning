 ...
 * @LastEditTime: 2026-01-22 16:54:20
 * @FilePath: /projects/p13_printf/bsp/uart/bsp_uart.c
 * @Description: 
 * 
...
#if 1
	 uart_setbaudrate(UART1, 9600, 80000000); /* 设置波特率 */
#endif
...
void putc(unsigned char c)
{
	...
	/* 等待 TxFIFO 未满 (bit 14: TXFE 或检查 FIFO 计数) */
	// while(((UART1->USR2 >> 14) & 0X01) == 0); 
